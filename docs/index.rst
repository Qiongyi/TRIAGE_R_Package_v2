...
This documentation provides step-by-step instructions for both **academic research and teaching** and **general** users to install and use the TRIAGE R package v2. If you have obtained `TRIAGE.Research_2.0.0.tar.gz` or `TRIAGE.General_2.0.0.tar.gz` via the UQ e-shop, you’re in the right place.
